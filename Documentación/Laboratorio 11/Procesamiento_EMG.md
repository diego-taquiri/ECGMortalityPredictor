...
- <p align="justify"><b>Filtrado:</b> El filtrado es esencial para reducir los artefactos en las señales de sEMG. [2] Existen filtros de Wavelet, Respuesta Finita al Impulso (FIR) y filtros de Respuesta Infinita al Impulso (IIR) con diversas subclases (desvanecimiento de bordes de ventana), y los especialistas pueden identificar configuraciones y coeficientes óptimos del filtro para adaptarse mejor a una señal para un propósito específico. [4] <br>
